...
def add_args(parser):
    ...
    parser.add_argument('--data_dir', type=str, default='data/Log/embeddings/BGL',
    ...
    parser.add_argument('--partition_size', type=int, default=600, metavar='N',
                        help='how to partition the dataset on local clients')
    ...
    parser.add_argument('--silos_number', type=int, default=5, metavar='NN',
                        help='number of silos in the FL system')

    parser.add_argument('--batch_size', type=int, default=50, metavar='N',
                        help='input batch size for training (default: 64)')

    parser.add_argument('--net', type=str, default='Head', metavar='N',
                        help='network arch:[resnet18, resnet56, SimpleCNN, modVGG]')

    parser.add_argument('--lr', type=float, default=0.01, metavar='LR',
                        help='learning rate (default: 0.01)')

    parser.add_argument('--momentum', type=bool, default=False, metavar='LR',
                        help='learning rate (default: 0.01)')
    ...
    parser.add_argument('--scale', type=float, default=5., metavar='MU',
                        help='mu value for various methods')
    ...
    parser.add_argument('--client_sample', type=float, default=0.4, metavar='MT',
